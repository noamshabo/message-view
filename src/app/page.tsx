...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-gray-100" dir="rtl">
        ...
        <div className="px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 disabled:bg-white/10 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none font-medium"
            >
      ...
      {/* Error Banner */}
      {error && (
        <div className="bg-gradient-to-r from-red-50 to-pink-50 border-b border-red-200 px-6 py-4 animate-slide-in">
        ...
        {loading ? (
          <div className="flex items-center justify-center w-full">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-600 font-medium text-lg">טוען הודעות...</p>
            </div>
          </div>
        ) : (
          <>
                    ...
                    <div className="bg-white border-b border-gray-200 px-6 py-4 shadow-md">
                      <div className="flex items-center space-x-4 space-x-reverse">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-500 mt-0.5 flex items-center space-x-2 space-x-reverse">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            <span>{conversationDetails.customer_phone}</span>
                            {conversationDetails.from_phone && (
                              <>
                                <span>•</span>
                                <span>{conversationDetails.from_phone}</span>
                              </>
                            )}
                          </div>
                        </div>
                      ...
                      {(conversationDetails.date_of_meeting || conversationDetails.customer_start_hour) && (
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          {conversationDetails.customer_start_hour && (
                            <div className="inline-flex items-center px-3 py-1 bg-pink-50 text-pink-700 rounded-full text-sm">
                              <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
